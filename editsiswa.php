...
<div class="sidebar p-4 bg-primary" id="sidebar">
 ...
 <div class="container">
  ...
  <select class="form-select" value="<?php echo $d['kelas']; ?>" aria-label="Default select example" name="kelas" id="" >
  ...
  <select class="form-select" value="<?php echo $d['jk']; ?>" aria-label="Default select example" name="jk" id="" >
