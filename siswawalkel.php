...
<nav class="navbar sticky-top bg-body-tertiary">
	<div class="container-fluid">
		...
		<form action="siswawalkel.php" method="get" class="d-flex" role="search">
...
<div class="sidebar p-4 bg-primary" id="sidebar">
			...
			<li>
              <a class="text-white" href="halaman_walikelas.php">
                <i class="bi bi-house mr-2"></i>
                Dashboard
              </a>
            </li>
            <li>
              <a class="text-white" href="siswawalkel.php">
                <i class="bi bi-people mr-2"></i>
                Data Siswa
              </a>
			</li>
            <li>
              <a class="text-white" href="cetak.php">
